...
**日期**：2026-07-13 ~ 07-19  
**必达周验收**：20 题评测集跑通；Markdown 知识库可带引用回答  
**进阶周验收**：50 题评测集；hybrid search + rerank + 拒答
...
## D27 · 周六 · 20/50 题评测集 v1

| 编码 120m | 必达：`eval/dataset.jsonl` 20 条；进阶：扩到 50 条；`eval/runner.py` 骨架 |
| 文档 30m | 标注规范说明 |
